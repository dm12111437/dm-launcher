...
contextBridge.exposeInMainWorld('dm', {
  ...
  setCustomIconLocal: (folder) => ipcRenderer.invoke('icon:set-local', folder),
  setCustomIconUrl: (folder, url) => ipcRenderer.invoke('icon:set-url', folder, url),
  clearCustomIcon: (folder) => ipcRenderer.invoke('icon:clear', folder),
